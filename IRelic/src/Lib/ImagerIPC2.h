...
IMAGERIPC_API HRESULT WINAPI GetClippedFormatMaxPos(WORD index, PPOINT Pos); // Part of NF1395
...
IMAGERIPC_API HRESULT WINAPI GetClippedFormatPos(WORD index, PPOINT Pos); // Part of NF1395
IMAGERIPC_API HRESULT WINAPI SetClippedFormatPos(WORD index, POINT Pos); // Part of NF1395
